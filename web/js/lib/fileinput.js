...
(function (factory) {
    ...
    tBtnDefault = '<button name="upload" type="{type}" tabindex="500" title="{title}" class="{css} uplodimage" {status}>{icon} {label}</button>';
    //noinspection HtmlUnknownAttribute
    ...
    tFooter = '<div class="file-thumbnail-footer">\n' +
        '    <div class="file-footer-caption"><textarea name="name" id="message" class="form-control" placeholder="Add image caption message"></textarea></div>\n'
        '</div>';
    ...
    $.fn.fileinput.defaults = {
        ...
        uploadIcon: '<i class="fa fa-hdd-o"></i>',
    ...
    $.fn.fileinputLocales.en = {
        ...
        uploadLabel: 'Save',
        uploadTitle: 'Save selected files',
        msgNo: 'No',
