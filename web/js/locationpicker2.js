...
(function($) {
    ...
    var GmUtility = {
        ...
        address_component_from_google_geocode: function(address_components) {            
           ...
           if($('#geocomplete'+shcounter).val() == undefined){
             
              var res =0;
           }else {
			var autofillstr = $('#geocomplete'+shcounter).val();
			var res = autofillstr.split(",");
           }
            ...
            result.addressLine2 = "";
			var addstr = result.addressLine1
			var n = addstr.search(res[0]); 
